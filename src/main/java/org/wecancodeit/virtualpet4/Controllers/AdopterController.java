...
public class AdopterController {
    ...
    public String editAdopter(@PathVariable Long id, Model model) throws Exception {
        AdoptersModel adopters = adoptersRepository.getById(id);
        AdopterDTO dto = new AdopterDTO(adopters);
        ...
        model.addAttribute("shelters", shelterRepository.getShelterLookUp());
    ...
    public String save(@ModelAttribute("adopters") AdopterDTO dto) throws Exception {
        AdoptersModel adopter = dto.convertToModel();
    ...
    /**
     * create method that uses the same page as the edit to create and save new
     * adopters
     */
    @GetMapping("/create")
    ...
    /**
     * confirmation method displays selected adopter to give user a chance to
     * confirm correct adopter is being deleted.
     */
